...
> **Looking for the Onepage MCP node (AI Agent tool)?** As of **v0.3.0** it has moved into its own
> package: [n8n-nodes-onepage-mcp](https://github.com/rjsebening/n8n-nodes-onepage-mcp)
